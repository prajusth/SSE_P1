...
![Violin CSV fast](../results/violin_fast_csv.png)
...
![Violin text default](../results/violin_default_text.png)
...
![Ratio vs energy scatter](../results/ratio_vs_energy.png)
...
![Efficiency default large](../results/efficiency_default_large.png)
...
![Level comparison heatmap](../results/level_comparison_heatmap.png)
...
![EDP fast large](../results/edp_fast_large.png)
...
![Histograms of non-normal groups](../results/non_normals.png)
